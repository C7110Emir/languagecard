...
import java from "./content/java.png";
import cpp from "./content/cpp.png";
import go from "./content/go.png";
import php from "./content/php.png";
import javascript from "./content/javascript.png";
